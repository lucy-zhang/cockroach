...
func (ConstraintValidity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{0}
}
...
func (ForeignKeyReference_Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{0, 0}
}
...
func (ForeignKeyReference_Match) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{0, 1}
}

type ForeignKeyConstraint_Action int32

const (
	ForeignKeyConstraint_NO_ACTION   ForeignKeyConstraint_Action = 0
	ForeignKeyConstraint_RESTRICT    ForeignKeyConstraint_Action = 1
	ForeignKeyConstraint_SET_NULL    ForeignKeyConstraint_Action = 2
	ForeignKeyConstraint_SET_DEFAULT ForeignKeyConstraint_Action = 3
	ForeignKeyConstraint_CASCADE     ForeignKeyConstraint_Action = 4
)

var ForeignKeyConstraint_Action_name = map[int32]string{
	0: "NO_ACTION",
	1: "RESTRICT",
	2: "SET_NULL",
	3: "SET_DEFAULT",
...
var ForeignKeyConstraint_Action_value = map[string]int32{
	"NO_ACTION":   0,
	"RESTRICT":    1,
	"SET_NULL":    2,
	"SET_DEFAULT": 3,
...
func (x ForeignKeyConstraint_Action) Enum() *ForeignKeyConstraint_Action {
	p := new(ForeignKeyConstraint_Action)
	*p = x
	return p
}
func (x ForeignKeyConstraint_Action) MarshalJSON() ([]byte, error) {
	return proto.MarshalJSONEnum(ForeignKeyConstraint_Action_name, int32(x))
}
func (x *ForeignKeyConstraint_Action) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ForeignKeyConstraint_Action_value, data, "ForeignKeyConstraint_Action")
	if err != nil {
		return err
	}
	*x = ForeignKeyConstraint_Action(value)
	return nil
}
func (ForeignKeyConstraint_Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{1, 0}
}

// Match is the algorithm used to compare composite keys.
type ForeignKeyConstraint_Match int32

const (
	ForeignKeyConstraint_SIMPLE  ForeignKeyConstraint_Match = 0
	ForeignKeyConstraint_FULL    ForeignKeyConstraint_Match = 1
	ForeignKeyConstraint_PARTIAL ForeignKeyConstraint_Match = 2
)

var ForeignKeyConstraint_Match_name = map[int32]string{
	0: "SIMPLE",
	1: "FULL",
	2: "PARTIAL",
}
var ForeignKeyConstraint_Match_value = map[string]int32{
	"SIMPLE":  0,
	"FULL":    1,
	"PARTIAL": 2,
}

func (x ForeignKeyConstraint_Match) Enum() *ForeignKeyConstraint_Match {
	p := new(ForeignKeyConstraint_Match)
	*p = x
	return p
}
func (x ForeignKeyConstraint_Match) MarshalJSON() ([]byte, error) {
	return proto.MarshalJSONEnum(ForeignKeyConstraint_Match_name, int32(x))
}
func (x *ForeignKeyConstraint_Match) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ForeignKeyConstraint_Match_value, data, "ForeignKeyConstraint_Match")
	if err != nil {
		return err
	}
	*x = ForeignKeyConstraint_Match(value)
	return nil
}
func (ForeignKeyConstraint_Match) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{1, 1}
}
...
func (IndexDescriptor_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{7, 0}
}
...
func (IndexDescriptor_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{7, 1}
}
...
func (ConstraintToUpdate_ConstraintType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{8, 0}
}
...
func (DescriptorMutation_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{9, 0}
}
...
func (DescriptorMutation_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{9, 1}
}
...
func (TableDescriptor_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 0}
}
...
func (TableDescriptor_AuditMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 1}
}
...
type ForeignKeyConstraint struct {
	TargetTable     ID                          `protobuf:"varint,1,opt,name=target_table,json=targetTable,casttype=ID" json:"target_table"`
	SourceColumnIDs []ColumnID                  `protobuf:"varint,2,rep,name=source_column_ids,json=sourceColumnIds,casttype=ColumnID" json:"source_column_ids,omitempty"`
	TargetColumnIDs []ColumnID                  `protobuf:"varint,3,rep,name=target_column_ids,json=targetColumnIds,casttype=ColumnID" json:"target_column_ids,omitempty"`
	...
	OnDelete        ForeignKeyConstraint_Action `protobuf:"varint,6,opt,name=on_delete,json=onDelete,enum=cockroach.sql.sqlbase.ForeignKeyConstraint_Action" json:"on_delete"`
	OnUpdate        ForeignKeyConstraint_Action `protobuf:"varint,7,opt,name=on_update,json=onUpdate,enum=cockroach.sql.sqlbase.ForeignKeyConstraint_Action" json:"on_update"`
	// This is only important for composite keys. For all prior matches before
	// the addition of this value, MATCH SIMPLE will be used.
	Match                ForeignKeyConstraint_Match `protobuf:"varint,8,opt,name=match,enum=cockroach.sql.sqlbase.ForeignKeyConstraint_Match" json:"match"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (*ForeignKeyConstraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{1}
}
...
type ForeignKeyBackreference struct {
	SourceTable          ID         `protobuf:"varint,1,opt,name=source_table,json=sourceTable,casttype=ID" json:"source_table"`
	SourceColumnIDs      []ColumnID `protobuf:"varint,2,rep,name=source_column_ids,json=sourceColumnIds,casttype=ColumnID" json:"source_column_ids,omitempty"`
	TargetColumnIDs      []ColumnID `protobuf:"varint,3,rep,name=target_column_ids,json=targetColumnIds,casttype=ColumnID" json:"target_column_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_sizecache        int32      `json:"-"`
...
func (*ForeignKeyBackreference) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{2}
}
...
func (*ColumnDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{3}
}
...
func (*ColumnFamilyDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{4}
}
...
func (*InterleaveDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{5}
}
...
func (*InterleaveDescriptor_Ancestor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{5, 0}
}
...
func (*PartitioningDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{6}
}
...
func (*PartitioningDescriptor_List) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{6, 0}
}
...
func (*PartitioningDescriptor_Range) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{6, 1}
}
...
func (*IndexDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{7}
}
...
func (*ConstraintToUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{8}
}
...
func (*DescriptorMutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{9}
}
...
type TableDescriptor struct {
	...
	OutFKs               []*ForeignKeyConstraint                `protobuf:"bytes,34,rep,name=out_fks,json=outFks" json:"out_fks,omitempty"`
	InFKs                []*ForeignKeyConstraint                `protobuf:"bytes,35,rep,name=in_fks,json=inFks" json:"in_fks,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                               `json:"-"`
	XXX_sizecache        int32                                  `json:"-"`
}
...
func (*TableDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10}
}
...
func (m *TableDescriptor) GetOutFKs() []*ForeignKeyConstraint {
	if m != nil {
		return m.OutFKs
	}
	return nil
...
func (m *TableDescriptor) GetInFKs() []*ForeignKeyConstraint {
	if m != nil {
		return m.InFKs
	}
	return nil
...
func (*TableDescriptor_NameInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 2}
}
...
func (*TableDescriptor_Reference) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 3}
}
...
func (*TableDescriptor_MutationJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 4}
}
...
func (*TableDescriptor_SequenceOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 5}
}
...
func (*TableDescriptor_Replacement) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 6}
}
...
func (*TableDescriptor_GCDescriptorMutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{10, 7}
}
...
func (*DatabaseDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{11}
}
...
func (*Descriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_16a105e89e2873eb, []int{12}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.sqlbase.ForeignKeyConstraint_Action", ForeignKeyConstraint_Action_name, ForeignKeyConstraint_Action_value)
	proto.RegisterEnum("cockroach.sql.sqlbase.ForeignKeyConstraint_Match", ForeignKeyConstraint_Match_name, ForeignKeyConstraint_Match_value)
...
func (m *ForeignKeyConstraint) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintStructured(dAtA, i, uint64(m.TargetTable))
	if len(m.SourceColumnIDs) > 0 {
		for _, num := range m.SourceColumnIDs {
			dAtA[i] = 0x10
			i++
			i = encodeVarintStructured(dAtA, i, uint64(num))
		}
	}
	if len(m.TargetColumnIDs) > 0 {
		for _, num := range m.TargetColumnIDs {
			dAtA[i] = 0x18
			i++
			i = encodeVarintStructured(dAtA, i, uint64(num))
		}
...
func (m *ForeignKeyBackreference) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintStructured(dAtA, i, uint64(m.SourceTable))
	if len(m.SourceColumnIDs) > 0 {
		for _, num := range m.SourceColumnIDs {
			dAtA[i] = 0x10
			i++
...
func (m *ForeignKeyConstraint) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovStructured(uint64(m.TargetTable))
	if len(m.SourceColumnIDs) > 0 {
		for _, e := range m.SourceColumnIDs {
			n += 1 + sovStructured(uint64(e))
		}
	}
	if len(m.TargetColumnIDs) > 0 {
		for _, e := range m.TargetColumnIDs {
			n += 1 + sovStructured(uint64(e))
		}
	}
	l = len(m.Name)
...
func (m *ForeignKeyBackreference) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovStructured(uint64(m.SourceTable))
	if len(m.SourceColumnIDs) > 0 {
		for _, e := range m.SourceColumnIDs {
			n += 1 + sovStructured(uint64(e))
		}
...
func (m *TableDescriptor) Size() (n int) {
	...
	if len(m.OutFKs) > 0 {
		for _, e := range m.OutFKs {
			l = e.Size()
			n += 2 + l + sovStructured(uint64(l))
		}
	}
	if len(m.InFKs) > 0 {
		for _, e := range m.InFKs {
			l = e.Size()
			n += 2 + l + sovStructured(uint64(l))
		}
	}
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				m.SourceColumnIDs = append(m.SourceColumnIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SourceColumnIDs) == 0 {
					m.SourceColumnIDs = make([]ColumnID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v ColumnID
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SourceColumnIDs", wireType)
			}
		case 3:
			if wireType == 0 {
				var v ColumnID
				...
				m.TargetColumnIDs = append(m.TargetColumnIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.TargetColumnIDs) == 0 {
					m.TargetColumnIDs = make([]ColumnID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v ColumnID
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field TargetColumnIDs", wireType)
			}
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Name", wireType)
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnDelete |= (ForeignKeyConstraint_Action(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnUpdate |= (ForeignKeyConstraint_Action(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Match |= (ForeignKeyConstraint_Match(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TableDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutFKs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutFKs = append(m.OutFKs, &ForeignKeyConstraint{})
			if err := m.OutFKs[len(m.OutFKs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 35:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InFKs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InFKs = append(m.InFKs, &ForeignKeyConstraint{})
			if err := m.InFKs[len(m.InFKs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("sql/sqlbase/structured.proto", fileDescriptor_structured_16a105e89e2873eb)
}

var fileDescriptor_structured_16a105e89e2873eb = []byte{
	// 3081 bytes of a gzipped FileDescriptorProto
	,
}
